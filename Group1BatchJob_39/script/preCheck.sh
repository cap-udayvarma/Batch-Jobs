...
source_folder="/home/udayvarma/Batch-jobs/Group1BatchJob_39/source/XFER/precheckin"

 

# Specify the destination folder

destination_folder="/home/udayvarma/Batch-jobs/Group1BatchJob_39/destination/eprndata/precheck/"
